...
def generate_word_document():
    try:
        from src.services.document_service import WordGenerator
        ...
        file_stream = generator.generate_document(content, filename, opts)
...
def generate_pdf_document():
    try:
        from src.services.document_service import PDFGenerator
        ...
        generator = PDFGenerator(font_paths=font_paths)
        buffer = generator.generate_document(content, filename, opts)
